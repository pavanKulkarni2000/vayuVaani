package com.vayuVaani.playMedia;
...
//                break;// do need bread,should let gestureDetector to handle event
    ...
    public void onVerticalScroll(float percent, int direction) {
        if (direction == ViewGestureListener.SWIPE_LEFT) {
            if (mCanControlBrightness) {
                mCenterImage.setImageResource(R.drawable.ic_baseline_brightness_6_24);
                updateBrightness(percent);
            }
        } else {
            if (mCanControlVolume) {
                mCenterImage.setImageResource(R.drawable.ic_baseline_volume_up_24);
    ...
    public static class Builder {
        ...
        @DrawableRes
        private int exitIcon = R.drawable.ic_baseline_arrow_back_24;
        @DrawableRes
        private int pauseIcon = R.drawable.ic_baseline_pause_24;
        @DrawableRes
        private int playIcon = R.drawable.ic_baseline_play_arrow_24;
        @DrawableRes
        private int shrinkIcon = R.drawable.ic_baseline_fullscreen_exit_24;
        @DrawableRes
        private int stretchIcon = R.drawable.ic_baseline_fullscreen_24;
